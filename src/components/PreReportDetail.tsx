...
export default function PreReportDetail({
  category,
  isApproveMode = false,
  onBack,
  brandReports = [],
  ...
  // Preview Brand Report Modal State
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody>
                  {brandReports.filter(r => r.brand === "Apple").length > 0 ? (
                    brandReports.filter(r => r.brand === "Apple").map((report, idx) => (
          ...
          {showPreviewModal && (
            <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
              ...
              <motion.div
                ...
                className="relative bg-white rounded-xl shadow-2xl z-20 w-full max-w-2xl overflow-hidden border border-gray-100"
              >
                <div className="p-6">
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-2 gap-6">
                      <div className="flex flex-col gap-1.5">
                        ...
                        <input
                          ...
                          value="Apple"
                          readOnly
                          className="w-full h-10 px-3 py-2 bg-gray-50 border border-gray-200 rounded-md text-[13px] text-gray-500 cursor-not-allowed focus:outline-none"
                        />
                      </div>
                      <div className="flex flex-col gap-1.5">
                        <label className="text-[13px] font-semibold text-[#4A5568]">
                    ...
                    <FilterField
                      ...
                      onChange={(val: string) =>
                        setPreviewForm({ ...previewForm, includeUnapproved: val })
                      }
                    ...
                    <div className="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
                      <button
                        onClick={() => setShowPreviewModal(false)}
                        className="px-6 py-2 border border-gray-300 text-gray-600 rounded-lg text-[13px] font-bold hover:bg-gray-50 transition-all"
                      >
                        Hủy bỏ
                      </button>
                      <button
                        onClick={() => {
                          if (!previewForm.reportType || !previewForm.fromDate || !previewForm.toDate || !previewForm.includeUnapproved) {
                          ...
                          const newReport: ExportRecord = {
                            id: newId,
                            reportCode: `BC_PREV_${Math.floor(1000 + Math.random() * 9000)}`,
                            brand: "Apple",
                          ...
                          setTimeout(() => {
                            ...
                            if (onUpdateBrandReport) {
                              onUpdateBrandReport(newId, { status: "success", downloadUrl: "#" });
                            }
                          }, 2500);
                        }}
                        className="px-8 py-2 bg-[#00529C] text-white rounded-lg text-[13px] font-bold hover:bg-[#00427D] transition-all shadow-md active:scale-95"
                      >
                        Xác nhận xem trước
                      </button>
                    </div>
